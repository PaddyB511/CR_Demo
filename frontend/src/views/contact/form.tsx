  ...
  return (
    <form onSubmit={onSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
      ...
      <div className="space-y-2">
        ...
        <div className="relative">
          <input
            ...
            className="w-full rounded-lg border border-neutral-200 bg-white px-4 py-3 outline-none focus:border-[#DB0000]"
          />
          {!!name && (
            <button
              type="button"
      ...
      <div className="space-y-2 md:row-span-3">
        <label className="text-sm font-medium">Message <span className="text-red-600">*</span></label>
        <div className="relative">
          <textarea
            value={message}
            ...
            rows={7}
            className="w-full rounded-lg border border-neutral-200 bg-white px-4 py-3 outline-none focus:border-[#DB0000] resize-y"
          />
          {!!message && (
            <button
              type="button"
      ...
      <div className="md:col-span-1 flex items-end">
        <button
          ...
          className="inline-flex items-center gap-2 rounded-full border border-[#DB0000] px-4 py-2 text-[#DB0000] font-medium hover:bg-[#DB0000]/5 disabled:opacity-60"
        >
